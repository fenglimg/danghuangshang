...
> 🏥 遇到问题？`bash <(curl -fsSL https://raw.githubusercontent.com/fenglimg/danghuangshang/local-host-install/doctor.sh)` 一键诊断
>
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/fenglimg/danghuangshang/local-host-install/doctor.sh)
```
